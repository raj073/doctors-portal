            ...
            <div className="hero">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    <div>
                        ...
                        <p className="text-white py-6">It is a long established fact that a reader will 
                        be distracted by the readable content of a page when looking at its layout. 
                        The point of using Lorem Industry that it has a more-or-less normal distribution 
